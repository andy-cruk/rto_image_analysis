...
# this is from Ben Hammer, https://github.com/benhamner/Metrics/blob/master/Python/ml_metrics/quadratic_weighted_kappa.py
import numpy as np
...
def quadratic_weighted_kappa(rater_a, rater_b, min_rating=None, max_rating=None):
    ...
    Peter Smittenaar edit to this function: remove NaNs
    """
    assert(len(rater_a) == len(rater_b))
    # Peter edits
    ...
    # if no more data left, return nan
    if len(rater_a) == 0:
        return np.nan
    # end of Peter edits
